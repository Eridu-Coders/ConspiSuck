...
class EcAppParamFacebook(LocalParam):
    ...
    gcm_days_depth = 14
    #: number of days after which the detailed liked list of a post or comment will be fetched
    gcm_likes_depth = 7
    #: number of days after which the shares list of a post will be fetched
    gcm_shares_depth = 7
